...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        // Primary palette - Teal + Amber + Deep Violet
        primary: {
          50: '#f0fdfa',
          100: '#ccfbf1',
          200: '#99f6e4',
      ...
      boxShadow: {
        ...
        'clay': '8px 8px 16px rgba(0, 0, 0, 0.3), -8px -8px 16px rgba(255, 255, 255, 0.05)',
        'clay-sm': '4px 4px 8px rgba(0, 0, 0, 0.3), -4px -4px 8px rgba(255, 255, 255, 0.05)',
